...
export default function CourseInfo() {
  ...
  return (
    <section className="relative py-16 md:py-24 bg-white/[0.02] border-y border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            ...
            />
            <h3 className="text-lg font-bold text-[var(--color-brand-primary)] uppercase tracking-wider">Nota Máxima no MEC</h3>
          </motion.a>
        </motion.div>
