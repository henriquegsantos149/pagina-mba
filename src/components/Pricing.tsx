...
export default function Pricing({ onOpenModal, isWaitingList = false }: PricingProps) {
  const benefits = [
    "Diploma de MBA com chancela Anhanguera (Nota Máxima no MEC)",
    "Programa completo de 12 meses com 400 horas de carga horária",
    "Aulas 100% EAD gravadas para assistir no seu próprio ritmo",
    "Estudos de caso reais focados em inteligência de dados e análise ambiental",
    "Foco prático no desenvolvimento e uso de ferramentas de análise espacial e Big Data",
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-[var(--color-brand-dark)]/70 max-w-2xl mx-auto font-secondary">
            Invista na especialização que prepara você para liderar a transformação digital no setor ambiental.
          </p>
        </div>
