    ...
    <section id="problema" className="py-16 md:py-24 relative overflow-hidden bg-[var(--color-brand-light)] text-[var(--color-brand-dark)]">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="flex items-center gap-3 text-[var(--color-brand-secondary)] mb-6 font-primary uppercase tracking-[0.2em] font-bold text-sm">
            ...
            <div className="space-y-6 text-lg text-[var(--color-brand-dark)]/80 font-secondary">
              <p>
          ...
          <motion.div
            ...
            className="shape-leaf bg-white border border-slate-200/80 p-10 relative overflow-hidden shadow-lg shadow-slate-200/50"
          >
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <h3 className="text-2xl font-bold font-primary uppercase tracking-wide text-[var(--color-brand-dark)]">Nosso Objetivo</h3>
            </div>

            <div className="space-y-8 text-[var(--color-brand-dark)]">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-[var(--color-brand-dark)] mb-1 uppercase tracking-wider text-sm">Soluções Visuais</h4>
                  <p className="text-[var(--color-brand-dark)]/70 text-sm">Transformar blocos de informação em Dashboards, WebMaps e relatórios interativos.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-[var(--color-brand-dark)] mb-1 uppercase tracking-wider text-sm">Orquestração de Dados</h4>
                  <p className="text-[var(--color-brand-dark)]/70 text-sm">Centralizar a informação ambiental para segurança técnica e lucros claros.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-[var(--color-brand-dark)] mb-1 uppercase tracking-wider text-sm">Cenários Antecipados</h4>
                  <p className="text-[var(--color-brand-dark)]/70 text-sm">Utilizar Ciência de Dados para antever riscos e otimizar licenciamentos.</p>
                </div>
              </div>
            </div>

            <div className="mt-10 pt-8 border-t border-slate-150 flex items-center gap-3 text-[var(--color-brand-secondary)] font-bold italic">
